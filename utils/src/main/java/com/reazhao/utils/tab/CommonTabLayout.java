...
import com.reazhao.utils.SizeUtils;
import com.reazhao.utils.tab.listener.CustomTabEntity;
import com.reazhao.utils.tab.listener.OnTabSelectListener;
import com.reazhao.utils.tab.utils.FragmentChangeManager;
import com.reazhao.utils.tab.utils.UnreadMsgUtils;
import com.reazhao.utils.tab.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        //设置线的位置，没有、上、下
        mIndicatorGravity = ta.getInt(R.styleable.CommonTabLayout_tl_indicator_gravity, Gravity.LEFT);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mUnderlineHeight > 0) {
            ...
            } else if(mUnderlineGravity==Gravity.TOP){
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                } else if (mIndicatorGravity == Gravity.TOP) {
                    mIndicatorDrawable.setBounds(paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left,
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            if (mIconGravity == Gravity.TOP || mIconGravity == Gravity.BOTTOM) {
                ...
                lp.topMargin = mHeight > 0 ? (int) (mHeight - textHeight - iconH - margin) / 2 - SizeUtils.dp2px(bottomPadding) : SizeUtils.dp2px(bottomPadding);
            } else {
                lp.leftMargin = SizeUtils.dp2px(leftPadding);
                lp.topMargin = mHeight > 0 ? (int) (mHeight - Math.max(textHeight, iconH)) / 2 - SizeUtils.dp2px(bottomPadding) : SizeUtils.dp2px(bottomPadding);
            }
