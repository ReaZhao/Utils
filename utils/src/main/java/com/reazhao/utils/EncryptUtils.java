...
import com.reazhao.utils.close.CloseUtils;
...
public class EncryptUtils {
     ...
     * @return 16进制密文
     */
    public static String encryptMD5ToString32(String data) {
     ...
     * @return 16进制密文
     */
    public static String encryptMD5ToString16(String data) {
        return encryptMD5ToString32(data).substring(8,24);
    }
