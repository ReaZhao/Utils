package com.reazhao.utils.popup;
...
import com.reazhao.utils.ScreenUtils;
 ...
 * @desc 功能描述：标题按钮上的弹窗（继承自PopupWindow）
 * </pre>
 */
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup( int width, int height){
		...
		//设置弹窗的布局界面
		setContentView(LayoutInflater.from(Utils.getContext()).inflate(R.layout.title_popup, null));
		...
		mListView.setAdapter(new BaseAdapter() {			
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if(convertView == null){
					...
					textView.setTextColor(Utils.getContext().getResources().getColor(android.R.color.white));
