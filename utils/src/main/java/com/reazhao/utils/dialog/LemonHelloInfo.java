package com.reazhao.utils.dialog;
...
import com.reazhao.utils.dialog.enums.LemonHelloIconLocation;
import com.reazhao.utils.dialog.interfaces.LemonHelloEventDelegate;
import com.reazhao.utils.dialog.interfaces.LemonPaintContext;
...
public class LemonHelloInfo {
    ...
    public void calViewsFrame(final LemonHelloView helloView,
        ...
        actionContainer.requestFocus();
        panelHeight = actionsY + actionsHeight;
        for (int i = 0; i < actions.size(); i++) {
            final LemonHelloAction action = actions.get(i);
            final Button actionView = new Button(actionContainer.getContext());
            ...
            actionView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
                @Override
                public void onFocusChange(View v, boolean hasFocus) {
                    if (hasFocus) {
                        actionView.setBackgroundColor(Color.parseColor("#908a8a8a"));
                    } else {
                        actionView.setBackgroundColor(action.getBackgroundHoverColor());
                    }
                }
            });
