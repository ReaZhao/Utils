package com.reazhao.utils.zxing;
...
import com.reazhao.utils.SDCardUtils;
...
public class QRCodeUtils {
     ...
     *
     * @param content   内容
     * @param widthPix  图片宽度  像素为单位
     * @param heightPix 图片高度 像素为单位
    ...
    public static boolean createQRImage(String content, int widthPix,
        ...
        try {
            ...
            String path = SDCardUtils.getSDCardPath() + "/qr_code";
            String file = createIfNotExist(path);
